...
angular.module('amnohfelsClientApp')
    .controller('NachtigallentalCtrl', function ($scope) {
        ...
        $scope.response[0] = {
            data: {
                caption: 'Ein ungeheim spaßiger Spaß für die ganze Familie',
                bgImgSrc: 'images/parallax/grillplatz.jpg',
                title: 'Grillplatz im Nachtigallental'
            },
